...
echo Site_Decorator::menu()
            ->set_detailed()
            ->set_right_aligned()
            ->set_title_light('Menu Light Detailed Right')
            ->add_item('Item 1<p>Description</p>', '#')
            ->add_item('Item 2<p>Description</p>', '#')
            ->render();
...
echo Site_Decorator::menu()
            ->set_padded()
            ->set_right_aligned()
            ->set_title_light('Menu Padded Light Right')
            ->add_item('Item 1', '#')
            ->add_item('Item 2', '#')
            ->render();
...
echo Site_Decorator::menu()
            ...
            ->set_detailed()
            ->set_right_aligned()
            ->set_title('Menu Padded Detailed Right')
            ->add_item('Item 1<p>Description</p>', '#')
            ->add_item('Item 2<p>Description</p>', '#')
            ->render();
...
echo Site_Decorator::menu()
            ...
            ->set_detailed()
            ->set_right_aligned()
            ->set_title_light('Menu Padded Light Detailed Right')
            ->add_item('Item 1<p>Description</p>', '#')
            ->add_item('Item 2<p>Description</p>', '#')
            ->render();
